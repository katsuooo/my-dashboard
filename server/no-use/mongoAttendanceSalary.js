 ...
 * 
 */
var mongoAttendanceSalary = {
    calcSalary: (appDate, socket)=>{
        ...
        const attendEditName = 'attend_edit_' + ym
        calcSalary('shushu', attendEditName, socket, 'READ_CALCED_EXPENCE_RESULT')
    },
...
module.exports = mongoAttendanceSalary;
